...
<body>
    ...
    <div class="container">
        ...
        ?>
         <!-- Tombol-tombol untuk menuju halaman tambahStokGudang dan pindah_stok -->
         <div class="mt-4 text-center">
            <a href="tambahStokGudang.php" class="btn btn-success">Tambah Stok Gudang</a>
            <a href="pindah_stok.php" class="btn btn-warning">Pindah Stok</a>
        </div>
